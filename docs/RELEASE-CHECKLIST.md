...
> 且都是不可逆的对外动作。
>
> ⚠️ 标题曾写「V0.1.0 发布清单」。首发一直被 npm 组织占名与建仓阻塞,
> 期间开发推进到 0.4.5,**首个公开版本因此是 0.4.5 而非 0.1.0**。
> 清单内容仍然适用,版本号以本行为准。
...
- [ ] ⚠️ **在 Linux 上重测冷启动与内存**,并更新 `FEASIBILITY-REPORT-V45.md` §6
      与 `DEPLOYMENT.md` §2.5 —— 当前数字来自 Windows 开发机
